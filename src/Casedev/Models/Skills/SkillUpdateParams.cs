...
/// </summary>
public record class SkillUpdateParams : ParamsBase
{
    ...
    public string? Summary
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<string>("summary");
        }
    ...
    public SkillUpdateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SkillUpdateParams(SkillUpdateParams skillUpdateParams)
        : base(skillUpdateParams)
    {
        this.Slug = skillUpdateParams.Slug;

        this._rawBodyData = new(skillUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static SkillUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string slug
    ...
    public virtual bool Equals(SkillUpdateParams? other)
    {
        if (other == null)
        {
            return false;
        }
        return (this.Slug?.Equals(other.Slug) ?? other.Slug == null)
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + string.Format("/skills/{0}", this.Slug)
        )
        {
