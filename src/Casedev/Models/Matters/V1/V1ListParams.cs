...
public record class V1ListParams : ParamsBase
{
    public string? MatterType
    {
        get
        {
            ...
            return this._rawQueryData.GetNullableClass<string>("matter_type");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("matter_type", value);
        }
    }
    ...
    public string? PracticeArea
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("practice_area");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("practice_area", value);
        }
    }
