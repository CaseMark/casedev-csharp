...
/// </summary>
public record class AgentTypeListParams : ParamsBase
{
    public bool? Active
    {
        get
    ...
    public AgentTypeListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AgentTypeListParams(AgentTypeListParams agentTypeListParams)
        : base(agentTypeListParams) { }
...
#pragma warning restore CS8618
    ...
    public static AgentTypeListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(AgentTypeListParams? other)
    {
        if (other == null)
        {
            return false;
