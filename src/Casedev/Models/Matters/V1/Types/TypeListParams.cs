...
/// </summary>
public record class TypeListParams : ParamsBase
{
    public bool? Active
    {
        get
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TypeListParams(TypeListParams typeListParams)
        : base(typeListParams) { }
...
#pragma warning restore CS8618
    ...
    public static TypeListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(TypeListParams? other)
    {
        if (other == null)
        {
            return false;
