...
/// </summary>
public record class LogCreateParams : ParamsBase
{
    ...
    public required string Summary
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullClass<string>("summary");
        }
    ...
    public LogCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public LogCreateParams(LogCreateParams logCreateParams)
        : base(logCreateParams)
    {
        this.ID = logCreateParams.ID;

        this._rawBodyData = new(logCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static LogCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(LogCreateParams? other)
    {
        if (other == null)
        {
            return false;
