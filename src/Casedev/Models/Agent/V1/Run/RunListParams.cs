...
/// <summary>
/// Lists agent runs for the authenticated organization. Supports filtering by agent,
...
public record class RunListParams : ParamsBase
{
    ...
    public string? AgentID
    {
        get
        {
            ...
            return this._rawQueryData.GetNullableClass<string>("agentId");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("agentId", value);
        }
    }

    /// <summary>
    /// Pagination cursor (run ID from previous page). Returns runs created before
    /// this run.
    /// </summary>
...
#pragma warning restore CS8618
    ...
    {
        return new System::UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/agent/v1/run")
        {
