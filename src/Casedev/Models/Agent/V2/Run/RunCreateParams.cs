...
/// <summary>
/// Creates a v2 run in queued state. Call POST /agent/v2/run/:id/exec to start execution
/// on the Daytona runtime.
///
...
public record class RunCreateParams : ParamsBase
{
    ...
    public required string AgentID
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullClass<string>("agentId");
        }
        init { this._rawBodyData.Set("agentId", value); }
    }
...
#pragma warning restore CS8618
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/agent/v2/run")
        {
