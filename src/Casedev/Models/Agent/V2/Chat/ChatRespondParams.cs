...
/// SSE events with stable turn, message, and part IDs. Emits events: `turn.started`,
/// `turn.status`, `message.created`, `message.part.updated`, `message.completed`,
/// `session.usage`, `turn.completed`.
///
    ...
    public override System::Uri Url(ClientOptions options)
    {
        return new System::UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/agent/v2/chat/{0}/respond", this.ID)
        )
        {
...
public sealed record class Part : JsonModel
{
    ...
    /// </summary>
    public required ApiEnum<string, global::Casedev.Models.Agent.V2.Chat.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::Casedev.Models.Agent.V2.Chat.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::Casedev.Models.Agent.V2.Chat.Type>
{
    public override global::Casedev.Models.Agent.V2.Chat.Type Read(
    ...
    )
    {
        ...
        {
            "text" => global::Casedev.Models.Agent.V2.Chat.Type.Text,
            _ => (global::Casedev.Models.Agent.V2.Chat.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Casedev.Models.Agent.V2.Chat.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Casedev.Models.Agent.V2.Chat.Type.Text => "text",
