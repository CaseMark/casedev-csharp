...
/// <summary>
/// Answers a pending OpenCode question for the Daytona-backed chat session and resumes
/// or recovers the runtime if needed.
///
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/agent/v2/chat/{0}/question/{1}/reply", this.ID, this.RequestID)
        )
        {
