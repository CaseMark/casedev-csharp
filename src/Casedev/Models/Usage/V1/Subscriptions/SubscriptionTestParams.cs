...
namespace Casedev.Models.Usage.V1.Subscriptions;

/// <summary>
/// Delivers a test event to a single usage webhook subscription using the same payload
/// shape and signing behavior as production delivery.
///
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/usage/v1/subscriptions/{0}/test", this.SubscriptionID)
        )
        {
