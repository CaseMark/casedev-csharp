...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<DocketDetail, DocketDetailFromRaw>))]
public sealed record class DocketDetail : JsonModel
{
    public string? ID
    {
        get
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DocketDetail(DocketDetail docketDetail)
        : base(docketDetail) { }
#pragma warning restore CS8618

    public DocketDetail(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    DocketDetail(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="DocketDetailFromRaw.FromRawUnchecked"/>
    public static DocketDetail FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class DocketDetailFromRaw : IFromRawJson<DocketDetail>
{
    /// <inheritdoc/>
    public DocketDetail FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        DocketDetail.FromRawUnchecked(rawData);
}
