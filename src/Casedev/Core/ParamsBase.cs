...
public abstract record class ParamsBase
{
    ...
    static ParamsBase()
    {
        ...
        var customHeadersEnv = Environment.GetEnvironmentVariable("CASEDEV_CUSTOM_HEADERS");
    ...
    static string GetUserAgent() => $"{typeof(CasedevClient).Name}/C# {GetPackageVersion()}";
