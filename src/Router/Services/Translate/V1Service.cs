...
public sealed class V1Service : IV1Service
{
    ...
    /// <inheritdoc/>
    public async Task<V1DetectResponse> Detect(
        V1DetectParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        using var response = await this
            .WithRawResponse.Detect(parameters, cancellationToken)
            .ConfigureAwait(false);
        return await response.Deserialize(cancellationToken).ConfigureAwait(false);
    }

    /// <inheritdoc/>
    public async Task<V1ListLanguagesResponse> ListLanguages(
        V1ListLanguagesParams? parameters = null,
        CancellationToken cancellationToken = default
    )
    {
        using var response = await this
            .WithRawResponse.ListLanguages(parameters, cancellationToken)
            .ConfigureAwait(false);
        return await response.Deserialize(cancellationToken).ConfigureAwait(false);
    }

    /// <inheritdoc/>
    public async Task<V1TranslateResponse> Translate(
        V1TranslateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        using var response = await this
            .WithRawResponse.Translate(parameters, cancellationToken)
            .ConfigureAwait(false);
        return await response.Deserialize(cancellationToken).ConfigureAwait(false);
    }
}
...
public sealed class V1ServiceWithRawResponse : IV1ServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<V1DetectResponse>> Detect(
        V1DetectParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        HttpRequest<V1DetectParams> request = new()
        {
        ...
        return new(
            ...
            async (token) =>
            {
                var deserializedResponse = await response
                    .Deserialize<V1DetectResponse>(token)
                    .ConfigureAwait(false);
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<V1ListLanguagesResponse>> ListLanguages(
        V1ListLanguagesParams? parameters = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        HttpRequest<V1ListLanguagesParams> request = new()
        {
        ...
        return new(
            ...
            {
                var deserializedResponse = await response
                    .Deserialize<V1ListLanguagesResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
                    deserializedResponse.Validate();
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<V1TranslateResponse>> Translate(
        V1TranslateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        HttpRequest<V1TranslateParams> request = new()
        {
            Method = HttpMethod.Post,
            Params = parameters,
        };
        ...
        return new(
            ...
            {
                var deserializedResponse = await response
                    .Deserialize<V1TranslateResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
                    deserializedResponse.Validate();
