...
public record class TemplateCreateParams : ParamsBase
{
    ...
    /// Template type
    /// </summary>
    public required ApiEnum<string, global::Router.Models.Format.V1.Templates.Type> Type
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<
                ApiEnum<string, global::Router.Models.Format.V1.Templates.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::Router.Models.Format.V1.Templates.Type>
{
    public override global::Router.Models.Format.V1.Templates.Type Read(
    ...
    )
    {
        ...
        {
            "caption" => global::Router.Models.Format.V1.Templates.Type.Caption,
            "signature" => global::Router.Models.Format.V1.Templates.Type.Signature,
            "letterhead" => global::Router.Models.Format.V1.Templates.Type.Letterhead,
            "certificate" => global::Router.Models.Format.V1.Templates.Type.Certificate,
            "footer" => global::Router.Models.Format.V1.Templates.Type.Footer,
            "custom" => global::Router.Models.Format.V1.Templates.Type.Custom,
            _ => (global::Router.Models.Format.V1.Templates.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Router.Models.Format.V1.Templates.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Router.Models.Format.V1.Templates.Type.Caption => "caption",
                global::Router.Models.Format.V1.Templates.Type.Signature => "signature",
                global::Router.Models.Format.V1.Templates.Type.Letterhead => "letterhead",
                global::Router.Models.Format.V1.Templates.Type.Certificate => "certificate",
                global::Router.Models.Format.V1.Templates.Type.Footer => "footer",
                global::Router.Models.Format.V1.Templates.Type.Custom => "custom",
