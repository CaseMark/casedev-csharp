...
public record class V1DownloadParams : ParamsBase
{
    ...
    public ApiEnum<string, global::Router.Models.Ocr.V1.Type>? Type { get; init; }
...
sealed class TypeConverter : JsonConverter<global::Router.Models.Ocr.V1.Type>
{
    public override global::Router.Models.Ocr.V1.Type Read(
    ...
    )
    {
        ...
        {
            "text" => global::Router.Models.Ocr.V1.Type.Text,
            "json" => global::Router.Models.Ocr.V1.Type.Json,
            "pdf" => global::Router.Models.Ocr.V1.Type.Pdf,
            "original" => global::Router.Models.Ocr.V1.Type.Original,
            _ => (global::Router.Models.Ocr.V1.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Router.Models.Ocr.V1.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Router.Models.Ocr.V1.Type.Text => "text",
                global::Router.Models.Ocr.V1.Type.Json => "json",
                global::Router.Models.Ocr.V1.Type.Pdf => "pdf",
                global::Router.Models.Ocr.V1.Type.Original => "original",
