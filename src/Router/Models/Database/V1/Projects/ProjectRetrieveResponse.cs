...
public sealed record class LinkedDeployment : JsonModel
{
    ...
    /// Deployment type
    /// </summary>
    public ApiEnum<string, global::Router.Models.Database.V1.Projects.Type>? Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                ApiEnum<string, global::Router.Models.Database.V1.Projects.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::Router.Models.Database.V1.Projects.Type>
{
    public override global::Router.Models.Database.V1.Projects.Type Read(
    ...
    )
    {
        ...
        {
            "thurgood" => global::Router.Models.Database.V1.Projects.Type.Thurgood,
            "compute" => global::Router.Models.Database.V1.Projects.Type.Compute,
            _ => (global::Router.Models.Database.V1.Projects.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Router.Models.Database.V1.Projects.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Router.Models.Database.V1.Projects.Type.Thurgood => "thurgood",
                global::Router.Models.Database.V1.Projects.Type.Compute => "compute",
