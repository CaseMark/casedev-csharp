...
public sealed record class EnvironmentVariable : JsonModel
{
    ...
    /// Variable type
    /// </summary>
    public ApiEnum<string, global::Router.Models.Applications.V1.Projects.Type>? Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                ApiEnum<string, global::Router.Models.Applications.V1.Projects.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::Router.Models.Applications.V1.Projects.Type>
{
    public override global::Router.Models.Applications.V1.Projects.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "plain" => global::Router.Models.Applications.V1.Projects.Type.Plain,
            "encrypted" => global::Router.Models.Applications.V1.Projects.Type.Encrypted,
            "secret" => global::Router.Models.Applications.V1.Projects.Type.Secret,
            _ => (global::Router.Models.Applications.V1.Projects.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Router.Models.Applications.V1.Projects.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Router.Models.Applications.V1.Projects.Type.Plain => "plain",
                global::Router.Models.Applications.V1.Projects.Type.Encrypted => "encrypted",
                global::Router.Models.Applications.V1.Projects.Type.Secret => "secret",
                _ => throw new CasedevInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
