...
namespace Router.Models.Superdoc.V1;
...
public sealed record class Field : JsonModel
{
    ...
    /// Field data type
    /// </summary>
    public required ApiEnum<string, global::Router.Models.Superdoc.V1.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::Router.Models.Superdoc.V1.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::Router.Models.Superdoc.V1.Type>
{
    public override global::Router.Models.Superdoc.V1.Type Read(
    ...
    )
    {
        ...
        {
            "text" => global::Router.Models.Superdoc.V1.Type.Text,
            "image" => global::Router.Models.Superdoc.V1.Type.Image,
            "date" => global::Router.Models.Superdoc.V1.Type.Date,
            "number" => global::Router.Models.Superdoc.V1.Type.Number,
            _ => (global::Router.Models.Superdoc.V1.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Router.Models.Superdoc.V1.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Router.Models.Superdoc.V1.Type.Text => "text",
                global::Router.Models.Superdoc.V1.Type.Image => "image",
                global::Router.Models.Superdoc.V1.Type.Date => "date",
                global::Router.Models.Superdoc.V1.Type.Number => "number",
