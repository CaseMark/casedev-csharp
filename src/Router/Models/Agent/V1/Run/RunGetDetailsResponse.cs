...
public sealed record class Step : JsonModel
{
    ...
    public ApiEnum<string, global::Router.Models.Agent.V1.Run.Type>? Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                ApiEnum<string, global::Router.Models.Agent.V1.Run.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::Router.Models.Agent.V1.Run.Type>
{
    public override global::Router.Models.Agent.V1.Run.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "output" => global::Router.Models.Agent.V1.Run.Type.Output,
            "thinking" => global::Router.Models.Agent.V1.Run.Type.Thinking,
            "tool_call" => global::Router.Models.Agent.V1.Run.Type.ToolCall,
            "tool_result" => global::Router.Models.Agent.V1.Run.Type.ToolResult,
            _ => (global::Router.Models.Agent.V1.Run.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Router.Models.Agent.V1.Run.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Router.Models.Agent.V1.Run.Type.Output => "output",
                global::Router.Models.Agent.V1.Run.Type.Thinking => "thinking",
                global::Router.Models.Agent.V1.Run.Type.ToolCall => "tool_call",
                global::Router.Models.Agent.V1.Run.Type.ToolResult => "tool_result",
                _ => throw new CasedevInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
