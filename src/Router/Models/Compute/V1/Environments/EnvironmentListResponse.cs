...
namespace Router.Models.Compute.V1.Environments;
...
{
    public IReadOnlyList<global::Router.Models.Compute.V1.Environments.Environment>? Environments
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<
                ImmutableArray<global::Router.Models.Compute.V1.Environments.Environment>
            >("environments");
        }
        init
        {
            ...
            this._rawData.Set<ImmutableArray<global::Router.Models.Compute.V1.Environments.Environment>?>(
                "environments",
...
[JsonConverter(
    typeof(JsonModelConverter<
        global::Router.Models.Compute.V1.Environments.Environment,
        EnvironmentFromRaw
    >)
)]
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public Environment(global::Router.Models.Compute.V1.Environments.Environment environment)
        : base(environment) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    public static global::Router.Models.Compute.V1.Environments.Environment FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class EnvironmentFromRaw : IFromRawJson<global::Router.Models.Compute.V1.Environments.Environment>
{
    /// <inheritdoc/>
    public global::Router.Models.Compute.V1.Environments.Environment FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => global::Router.Models.Compute.V1.Environments.Environment.FromRawUnchecked(rawData);
}
