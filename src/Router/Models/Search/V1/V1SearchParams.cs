...
public record class V1SearchParams : ParamsBase
{
    ...
    /// </summary>
    public ApiEnum<string, global::Router.Models.Search.V1.Type>? Type
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<
                ApiEnum<string, global::Router.Models.Search.V1.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::Router.Models.Search.V1.Type>
{
    public override global::Router.Models.Search.V1.Type Read(
    ...
    )
    {
        ...
        {
            "auto" => global::Router.Models.Search.V1.Type.Auto,
            "search" => global::Router.Models.Search.V1.Type.Search,
            "news" => global::Router.Models.Search.V1.Type.News,
            _ => (global::Router.Models.Search.V1.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Router.Models.Search.V1.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Router.Models.Search.V1.Type.Auto => "auto",
                global::Router.Models.Search.V1.Type.Search => "search",
                global::Router.Models.Search.V1.Type.News => "news",
