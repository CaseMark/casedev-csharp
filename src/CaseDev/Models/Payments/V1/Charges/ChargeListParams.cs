...
/// </summary>
public record class ChargeListParams : ParamsBase
{
    public string? DestinationAccountID
    {
        get
        {
            ...
            return this._rawQueryData.GetNullableClass<string>("destination_account_id");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("destination_account_id", value);
        }
    }
    ...
    public ChargeListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ChargeListParams(ChargeListParams chargeListParams)
        : base(chargeListParams) { }
...
#pragma warning restore CS8618
    ...
    public static ChargeListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ChargeListParams? other)
    {
        if (other == null)
        {
            return false;
