...
/// </summary>
public record class HoldListParams : ParamsBase
{
    ...
    public HoldListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public HoldListParams(HoldListParams holdListParams)
        : base(holdListParams) { }
...
#pragma warning restore CS8618
    ...
    public static HoldListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(HoldListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/payments/v1/holds")
        {
