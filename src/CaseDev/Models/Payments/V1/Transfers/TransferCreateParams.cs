...
/// </summary>
public record class TransferCreateParams : ParamsBase
{
    ...
    public TransferCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public TransferCreateParams(TransferCreateParams transferCreateParams)
        : base(transferCreateParams)
    {
        this._rawBodyData = new(transferCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static TransferCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(TransferCreateParams? other)
    {
        if (other == null)
        {
            return false;
