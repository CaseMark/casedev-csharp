...
public record class V1DetectParams : ParamsBase
{
    ...
    public required Q Q
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullClass<Q>("q");
        }
...
#pragma warning restore CS8618
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/translate/v1/detect")
        {
...
/// Text to detect language for. Can be a single string or an array for batch detection.
/// </summary>
[JsonConverter(typeof(QConverter))]
public record class Q : ModelBase
{
    ...
    public Q(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Q(IReadOnlyList<string> value, JsonElement? element = null)
    {
        this.Value = ImmutableArray.ToImmutableArray(value);
        this._element = element;
    }

    public Q(JsonElement element)
    {
        this._element = element;
    }
    ...
    public void Switch(Action<string> @string, Action<IReadOnlyList<string>> strings)
    {
        switch (this.Value)
        {
            ...
            case IReadOnlyList<string> value:
                ...
                break;
            default:
                throw new CasedevInvalidDataException("Data did not match any variant of Q");
        }
    }
    ...
    public T Match<T>(Func<string, T> @string, Func<IReadOnlyList<string>, T> strings)
    {
        return this.Value switch
        {
            ...
            _ => throw new CasedevInvalidDataException("Data did not match any variant of Q"),
        };
    }

    public static implicit operator Q(string value) => new(value);

    public static implicit operator Q(List<string> value) => new((IReadOnlyList<string>)value);
    ...
    public virtual bool Equals(Q? other) =>
        other != null
...
sealed class QConverter : JsonConverter<Q>
{
    public override Q? Read(
