...
/// chunks, and create embeddings. Processing happens asynchronously. GraphRAG indexing
/// must be triggered separately via POST /vault/:id/graphrag/:objectId. Returns immediately
