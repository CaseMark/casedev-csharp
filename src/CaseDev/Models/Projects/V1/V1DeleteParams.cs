...
public record class V1DeleteParams : ParamsBase
{
    ...
    public bool? DeleteDeployments
    {
        get
        {
            ...
            return this._rawQueryData.GetNullableStruct<bool>("deleteDeployments");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("deleteDeployments", value);
        }
    }
...
#pragma warning restore CS8618
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + string.Format("/projects/v1/{0}", this.ID)
        )
        {
