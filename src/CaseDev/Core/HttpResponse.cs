...
public class HttpResponse : IDisposable
{
    ...
    {
        if (obj is not global::CaseDev.Core.HttpResponse other)
        {
            return false;
        }
    ...
    public async Task<T> Deserialize<T>(Threading::CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            return await JsonSerializer
                ...
                ?? throw new CasedevInvalidDataException("Response cannot be null");
        }
...
public sealed class HttpResponse<T> : global::CaseDev.Core.HttpResponse
{
    ...
    internal HttpResponse(
        global::CaseDev.Core.HttpResponse response,
...
public sealed class StreamingHttpResponse<T> : global::CaseDev.Core.HttpResponse
{
