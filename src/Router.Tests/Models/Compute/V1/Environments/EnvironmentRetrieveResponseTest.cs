...
public class EnvironmentRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EnvironmentRetrieveResponse
        {
            ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<EnvironmentRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        EnvironmentRetrieveResponse copied = new(model);
