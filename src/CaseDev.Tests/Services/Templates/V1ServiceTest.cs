...
public class V1ServiceTest : TestBase
{
    ...
    {
        await this.client.Templates.V1.Retrieve("id");
    }

    [Fact(Skip = "Prism tests are disabled")]
    public async Task List_Works()
    {
        await this.client.Templates.V1.List();
    }
    ...
    {
        await this.client.Templates.V1.RetrieveExecution("exec_abc123def456");
    }

    [Fact(Skip = "Prism tests are disabled")]
    public async Task Search_Works()
    {
        await this.client.Templates.V1.Search(new() { Query = "query" });
    }
}
