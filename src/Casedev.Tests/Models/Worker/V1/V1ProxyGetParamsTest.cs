...
public class V1ProxyGetParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new V1ProxyGetParams { ID = "id", WorkerPath = "workerPath" };
    ...
    {
        V1ProxyGetParams parameters = new() { ID = "id", WorkerPath = "workerPath" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        V1ProxyGetParams copied = new(parameters);
