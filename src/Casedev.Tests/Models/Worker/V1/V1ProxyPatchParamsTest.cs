...
public class V1ProxyPatchParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new V1ProxyPatchParams { ID = "id", WorkerPath = "workerPath" };
    ...
    {
        V1ProxyPatchParams parameters = new() { ID = "id", WorkerPath = "workerPath" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        V1ProxyPatchParams copied = new(parameters);
