...
public class V1ProxyDeleteParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new V1ProxyDeleteParams { ID = "id", WorkerPath = "workerPath" };
    ...
    {
        V1ProxyDeleteParams parameters = new() { ID = "id", WorkerPath = "workerPath" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        V1ProxyDeleteParams copied = new(parameters);
