...
public class ChatUiStreamParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ChatUiStreamParams
        {
            ID = "id",
    ...
    {
        ChatUiStreamParams parameters = new()
        {
            ID = "id",
            Body = JsonSerializer.Deserialize<JsonElement>("{}"),
        };
        ...
        Assert.Equal(new Uri("https://api.case.dev/agent/v1/chat/id/ui-stream"), url);
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        ChatUiStreamParams copied = new(parameters);
