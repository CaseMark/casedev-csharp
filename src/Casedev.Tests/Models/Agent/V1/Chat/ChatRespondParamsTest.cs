...
public class ChatRespondParamsTest : TestBase
{
    ...
    {
        var parameters = new ChatRespondParams
        {
            ID = "id",
    ...
    {
        ChatRespondParams parameters = new()
        {
            ID = "id",
            Body = JsonSerializer.Deserialize<JsonElement>("{}"),
        };
        ...
        Assert.Equal(new Uri("https://api.case.dev/agent/v1/chat/id/respond"), url);
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        ChatRespondParams copied = new(parameters);
