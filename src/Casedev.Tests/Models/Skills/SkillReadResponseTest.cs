...
public class SkillReadResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new SkillReadResponse
        {
            ...
            Bundle = new ReadResponseRootBundle()
            {
                Files =
                [
                    new()
        ...
        Bundle expectedBundle = new ReadResponseRootBundle()
        {
            Files =
            [
                new()
...
{
    [Fact]
    public void ReadResponseRootValidationWorks()
    {
        Bundle value = new ReadResponseRootBundle()
        {
            Files =
            [
                new()
    ...
    [Fact]
    public void ReadResponseFileValidationWorks()
    {
        Bundle value = new ReadResponseFileBundle()
        {
            Path = "path",
            Role = Role.File,
            RootSlug = "root_slug",
    ...
    [Fact]
    public void ReadResponseRootSerializationRoundtripWorks()
    {
        Bundle value = new ReadResponseRootBundle()
        {
            Files =
    ...
    [Fact]
    public void ReadResponseFileSerializationRoundtripWorks()
    {
        Bundle value = new ReadResponseFileBundle()
        {
            Path = "path",
