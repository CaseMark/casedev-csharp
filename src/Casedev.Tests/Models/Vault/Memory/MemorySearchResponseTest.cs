...
public class MemorySearchResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new MemorySearchResponse
        {
            Results =
            [
                new()
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<MemorySearchResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        MemorySearchResponse copied = new(model);
...
public class ResultTest : TestBase
{
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new Result { CreatedBy = "created_by", Source = "source" };
