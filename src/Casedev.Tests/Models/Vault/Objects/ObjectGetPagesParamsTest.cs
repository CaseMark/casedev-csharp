...
public class ObjectGetPagesParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ObjectGetPagesParams
        {
            ID = "id",
            ObjectID = "objectId",
            End = 0,
    ...
    {
        var parameters = new ObjectGetPagesParams { ID = "id", ObjectID = "objectId" };
    ...
    {
        ObjectGetPagesParams parameters = new()
        {
            ID = "id",
            ObjectID = "objectId",
            End = 0,
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri("https://api.case.dev/vault/id/objects/objectId/pages?end=0&start=0"),
                url
            )
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        ObjectGetPagesParams copied = new(parameters);
