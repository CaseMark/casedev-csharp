...
public class DocketSearchResultTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DocketSearchResult
        {
            ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<DocketSearchResult>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        DocketSearchResult copied = new(model);
