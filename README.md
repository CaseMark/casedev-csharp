...
using var response = await client.Agent.V1.Chat.Files.Download(parameters);
...
var parameters = ChatCreateCompletionParams.FromRawUnchecked
(
...
AgentCreateParams parameters = new()
{
    Sandbox = Sandbox.FromRawUnchecked
    (
        new Dictionary<string, JsonElement>
        {
